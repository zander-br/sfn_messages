...
from sfn_messages.str.str0008 import STR0008, STR0008E, STR0008R1, STR0008R2
...
def make_valid_str0008r2_params() -> dict[str, Any]:
    return {
        'amount': 100.00,
        'creditor_account_number': '123456',
        'creditor_account_type': 'DEPOSIT',
...
def make_valid_str0008e_params(*, general_error: bool = False) -> dict[str, Any]:
    str0008e = {
        'amount': 100.00,
        'creditor_account_number': '123456',
        'creditor_account_type': 'DEPOSIT',
    ...
    if general_error:
        str0008e['general_error_code'] = 'EGEN0050'
    else:
        str0008e['debtor_institution_ispb_error_code'] = 'EGEN0051'
...
def test_str0008e_general_error_valid_model() -> None:
    params = make_valid_str0008e_params(general_error=True)
    str0008e = STR0008E.model_validate(params)
    assert isinstance(str0008e, STR0008E)
    assert str0008e.amount == Decimal('100.00')
    assert str0008e.creditor_account_number == '123456'
    assert str0008e.creditor_account_type == AccountType.DEPOSIT
    assert str0008e.creditor_branch == '0001'
    assert str0008e.creditor_document == '69327934075'
    assert str0008e.creditor_institution_ispb == '60701190'
    assert str0008e.creditor_name == 'Joe Doe'
    assert str0008e.creditor_payment_account_number is None
    assert str0008e.creditor_type == PersonType.INDIVIDUAL
    assert str0008e.debtor_account_number == '654321'
    assert str0008e.debtor_account_type == AccountType.CURRENT
    assert str0008e.debtor_branch == '0002'
    assert str0008e.debtor_document == '56369416000136'
    assert str0008e.debtor_institution_ispb == '31680151'
    assert str0008e.debtor_name == 'ACME Inc'
    assert str0008e.debtor_payment_account_number is None
    assert str0008e.debtor_type == PersonType.BUSINESS
    ...
    assert str0008e.scheduled_time == time(15, 30)
    assert str0008e.settlement_date == date(2025, 9, 8)
    assert str0008e.system_domain == 'SPB01'
    assert str0008e.to_ispb == '00038166'
    assert str0008e.transaction_id == '0000000000000000000000001'
    assert str0008e.general_error_code == 'EGEN0050'


def test_str0008e_tag_error_valid_model() -> None:
    params = make_valid_str0008e_params()
    str0008e = STR0008E.model_validate(params)
    assert isinstance(str0008e, STR0008E)
    assert str0008e.amount == Decimal('100.00')
    assert str0008e.creditor_account_number == '123456'
    ...
    assert str0008e.to_ispb == '00038166'
    assert str0008e.transaction_id == '0000000000000000000000001'
    assert str0008e.debtor_institution_ispb_error_code == 'EGEN0051'
...
def test_str0008_to_xml() -> None:
    ...
    <DOC xmlns="http://www.bcb.gov.br/SPB/STR0008.xsd">
        <BCMSG>
...
def test_str0008e_general_error_to_xml() -> None:
    params = make_valid_str0008e_params(general_error=True)
    str0008e = STR0008E.model_validate(params)
    xml = str0008e.to_xml()

    expected_xml = """<?xml version="1.0"?>
    <DOC xmlns="http://www.bcb.gov.br/SPB/STR0008E.xsd">
        <BCMSG>
            <IdentdEmissor>31680151</IdentdEmissor>
            <IdentdDestinatario>00038166</IdentdDestinatario>
            <DomSist>SPB01</DomSist>
...
def test_str0008e_tag_error_to_xml() -> None:
    params = make_valid_str0008e_params()
    str0008e = STR0008E.model_validate(params)
    xml = str0008e.to_xml()
...
def test_str0008e_general_error_from_xml() -> None:
    xml = """<?xml version="1.0"?>
    <DOC xmlns="http://www.bcb.gov.br/SPB/STR0008E.xsd">
        <BCMSG>
            <IdentdEmissor>31680151</IdentdEmissor>
    ...
    str0008e = STR0008E.from_xml(xml)
    assert isinstance(str0008e, STR0008E)
    assert str0008e.amount == Decimal('100.0')
    assert str0008e.creditor_account_number == '123456'
    assert str0008e.creditor_account_type == AccountType.DEPOSIT
    assert str0008e.creditor_branch == '0001'
    assert str0008e.creditor_document == '69327934075'
...
def test_str0008e_tag_error_from_xml() -> None:
    xml = """<?xml version="1.0"?>
    <DOC xmlns="http://www.bcb.gov.br/SPB/STR0008E.xsd">
        <BCMSG>
            <IdentdEmissor>31680151</IdentdEmissor>
...
def test_str0008r2_valid_model() -> None:
    params = make_valid_str0008r2_params()
    str0008r2 = STR0008R2.model_validate(params)
    assert isinstance(str0008r2, STR0008R2)
    assert str0008r2.amount == Decimal('100.00')
    assert str0008r2.creditor_account_number == '123456'
    assert str0008r2.creditor_account_type == AccountType.DEPOSIT
    assert str0008r2.creditor_branch == '0001'
    assert str0008r2.creditor_document == '69327934075'
    assert str0008r2.creditor_institution_ispb == '60701190'
    assert str0008r2.creditor_name == 'Joe Doe'
    assert str0008r2.creditor_payment_account_number is None
    assert str0008r2.creditor_type == PersonType.INDIVIDUAL
    assert str0008r2.debtor_account_number == '654321'
    assert str0008r2.debtor_account_type == AccountType.CURRENT
    assert str0008r2.debtor_branch == '0002'
    assert str0008r2.debtor_document == '56369416000136'
    assert str0008r2.debtor_institution_ispb == '31680151'
    assert str0008r2.debtor_name == 'ACME Inc'
    assert str0008r2.debtor_payment_account_number is None
...
def test_str0008r2_missing_required_fields() -> None:
    with pytest.raises(ValidationError) as exc:
        STR0008R2.model_validate({})
    missing_fields = extract_missing_fields(exc.value)
    assert missing_fields == {
        'amount',
        'creditor_institution_ispb',
...
def test_str0008r2_business_rules_invalid_documents() -> None:
    params = make_valid_str0008r2_params()
    params['debtor_type'] = 'INDIVIDUAL'
    params['debtor_document'] = '56369416000136'
    params['creditor_type'] = 'BUSINESS'
...
def test_str0008r2_business_rules_missing_description_for_other_purpose() -> None:
    params = make_valid_str0008r2_params()
    params['purpose'] = 'OTHERS'
    del params['description']
...
def test_str0008r2_business_rules_missing_creditor_branch_for_creditor_account_type_is_not_payment() -> None:
    params = make_valid_str0008r2_params()
    params['creditor_account_type'] = 'CURRENT'
    del params['creditor_branch']
...
def test_str0008r2_business_rules_missing_debtor_payment_account_number_for_debtor_account_type_is_payment() -> None:
    params = make_valid_str0008r2_params()
    params['debtor_account_type'] = 'PAYMENT'
...
def test_str0008r2_business_rules_missing_creditor_payment_account_number_for_creditor_account_type_is_payment() -> (
    None
):
    params = make_valid_str0008r2_params()
    params['creditor_account_type'] = 'PAYMENT'
...
def test_str0008r2_business_rules_missing_debtor_account_number_for_debtor_account_type_is_not_payment() -> None:
    params = make_valid_str0008r2_params()
    params['debtor_account_type'] = 'CURRENT'
    del params['debtor_account_number']
...
def test_str0008r2_business_rules_missing_creditor_account_number_for_creditor_account_type_is_not_payment() -> None:
    params = make_valid_str0008r2_params()
    params['creditor_account_type'] = 'CURRENT'
    del params['creditor_account_number']
...
def test_str0008r2_to_xml() -> None:
    params = make_valid_str0008r2_params()
    str0008r2 = STR0008R2.model_validate(params)
    xml = str0008r2.to_xml()
...
def test_str0008r2_to_xml_omit_optional_fields() -> None:
    params = make_valid_str0008r2_params()
    del params['description']
    del params['transaction_id']
...
def test_str0008r2_from_xml() -> None:
    xml = """<?xml version="1.0"?>
    <DOC xmlns="http://www.bcb.gov.br/SPB/STR0008.xsd">
        <BCMSG>
            <IdentdEmissor>31680151</IdentdEmissor>
    ...
    str0008r2 = STR0008R2.from_xml(xml)
    assert isinstance(str0008r2, STR0008R2)
    assert str0008r2.amount == Decimal('100.0')
    assert str0008r2.creditor_account_number == '123456'
    assert str0008r2.creditor_account_type == AccountType.DEPOSIT
    assert str0008r2.creditor_branch == '0001'
    assert str0008r2.creditor_document == '69327934075'
...
def test_str0008r2_roundtrip() -> None:
    ...
    str0008r2 = STR0008R2.model_validate(params)
    xml = str0008r2.to_xml()
    str0008r2_from_xml = STR0008R2.from_xml(xml)
    assert str0008r2 == str0008r2_from_xml


def test_str0008r2_from_xml_missing_required_fields() -> None:
    xml = """<?xml version="1.0"?>
    <DOC xmlns="http://www.bcb.gov.br/SPB/STR0008.xsd">
        <BCMSG>
            <IdentdEmissor>31680151</IdentdEmissor>
