...
def test_str0010_valid_params() -> None:
    ...
    assert str0010.operation_number == '31680151250908000000001'
...
def test_str0010e_general_error_valid_params() -> None:
    ...
    assert str0010e.operation_number == '31680151250908000000001'
...
def test_str0010e_general_error_to_xml() -> None:
    ...
    <DOC xmlns="http://www.bcb.gov.br/SPB/STR0010E.xsd">
        ...
        <SISMSG>
            <STR0010 CodErro="EGEN0050">
                <CodMsg>STR0010E</CodMsg>
                <NumCtrlIF>31680151202509090425</NumCtrlIF>
                <ISPBIFDebtd>31680151</ISPBIFDebtd>
                <ISPBIFCredtd>60701190</ISPBIFCredtd>
                <VlrLanc>100.0</VlrLanc>
...
def test_str0010r1_valid_model() -> None:
    ...
    assert str0010r1.operation_number == '31680151250908000000001'
    assert str0010r1.settlement_date == date(2025, 9, 8)
    assert str0010r1.settlement_timestamp == datetime(2025, 11, 20, 15, 30)
...
def test_str0010r2_valid_params() -> None:
    ...
    assert str0010r2.operation_number == '31680151250908000000001'
    ...
    assert str0010r2.vendor_timestamp == datetime(2025, 11, 20, 15, 30)
