        ...
        'schedule_grid_group': [
            {
                ...
                'opening_hour': '2025-11-28T08:00:00',
                'closing_hour': '2025-11-28T18:30:00',
                'hour_type': 'STANDARD',
            },
            {
                'code': 'CBLC_PUBLIC_FIXED_INCOME_CLEARING',
                'opening_hour': '2025-11-28T08:00:00',
                'closing_hour': '2025-11-28T21:00:00',
                'hour_type': 'STANDARD',
            },
        ],
        'reference_date': '2025-11-28',
        'provider_datetime': '2025-11-28T16:01:00',
...
def test_gen0021_valid_model() -> None:
    ...
    assert gen0021.provider_datetime == datetime(2025, 11, 28, 16, 1)
    ...
    assert grid1.opening_hour == datetime(2025, 11, 28, 8, 0)
    assert grid1.closing_hour == datetime(2025, 11, 28, 18, 30)
    ...
    assert grid2.opening_hour == datetime(2025, 11, 28, 8, 0)
    assert grid2.closing_hour == datetime(2025, 11, 28, 21, 0)
...
def test_gen0021e_general_error_valid_model() -> None:
    ...
    assert gen0021e.message_code == 'GEN0021E'
    ...
    assert gen0021e.provider_datetime == datetime(2025, 11, 28, 16, 1)
        ...
        <SISMSG>
            <GEN0021>
                ...
                <Grupo_GEN0021_GrdHrio>
                    <CodGrd>CAM04</CodGrd>
                    <DtHrAbert>2025-11-28T08:00:00</DtHrAbert>
                    <DtHrFcht>2025-11-28T18:30:00</DtHrFcht>
                    <TpHrio>P</TpHrio>
                </Grupo_GEN0021_GrdHrio>
                <Grupo_GEN0021_GrdHrio>
                    <CodGrd>CBL89</CodGrd>
                    <DtHrAbert>2025-11-28T08:00:00</DtHrAbert>
                    <DtHrFcht>2025-11-28T21:00:00</DtHrFcht>
                    <TpHrio>P</TpHrio>
                </Grupo_GEN0021_GrdHrio>
                <DtRef>2025-11-28</DtRef>
                <DtHrPrestd>2025-11-28T16:01:00</DtHrPrestd>
...
def test_gen0021e_general_error_to_xml() -> None:
    ...
    <DOC xmlns="http://www.bcb.gov.br/GEN/GEN0021E.xsd">
        ...
        <SISMSG>
            <GEN0021 CodErro="EGEN0050">
                <CodMsg>GEN0021E</CodMsg>
                <ISPBPrestd>31680151</ISPBPrestd>
                <CodProdt>VIC</CodProdt>
                <Grupo_GEN0021_GrdHrio>
                    <CodGrd>CAM04</CodGrd>
