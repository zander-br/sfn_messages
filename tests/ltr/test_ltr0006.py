...
from sfn_messages.ltr.ltr0006 import LTR0006, LTR0006R1, LTR0006R2
...
def test_ltr0006_valid_model() -> None:
    ...
    assert ltr0006.operation_number == '316801512509080000001'
...
def test_ltr0006r1_valid_model() -> None:
    ...
    assert ltr0006r1.operation_number == '316801512509080000001'
...
def test_ltr0006r2_valid_model() -> None:
    ...
    assert ltr0006r2.operation_number == '316801512509080000001'
