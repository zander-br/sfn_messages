...
class STR0007E(PartyValidations, BaseMessage):
    ...
    message_code: Annotated[Literal['STR0007'], XmlPath(f'{PATH_E}/CodMsg/text()')] = 'STR0007'
    ...
    sender_document: Annotated[Cnpj | Cpf | None, XmlPath(f'{PATH_E}/CNPJ_CPFRemet/text()')] = None
    ...
    purpose: Annotated[InstitutionPurpose, XmlPath(f'{PATH_E}/FinlddIF/text()')]
