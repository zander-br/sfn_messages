...
class STR0013E(BaseMessage):
    ...
    message_code: Annotated[Literal['STR0013'], XmlPath(f'{PATH_E}/CodMsg/text()')] = 'STR0013'
    institution_control_number: Annotated[InstitutionControlNumber, XmlPath(f'{PATH_E}/NumCtrlIF_LDL/text()')]
    institution_ispb: Annotated[Ispb, XmlPath(f'{PATH_E}/ISPBIF_LDL/text()')]
