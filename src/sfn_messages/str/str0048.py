...
class STR0048E(BaseMessage):
    ...
    message_code: Annotated[Literal['STR0048'], XmlPath(f'{PATH_E}/CodMsg/text()')] = 'STR0048'
    ...
    portability_return_reason: Annotated[PortabilityReturnReason, XmlPath(f'{PATH_E}/CodDevPortdd/text()')]
