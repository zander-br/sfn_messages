...
class STR0025E(PartyValidations, BaseMessage):
    ...
    message_code: Annotated[Literal['STR0025'], XmlPath(f'{PATH_E}/CodMsg/text()')] = 'STR0025'
    ...
    deposit_identifier: Annotated[DepositIdentifier, XmlPath(f'{PATH_E}/IdentcDep/text()')]
