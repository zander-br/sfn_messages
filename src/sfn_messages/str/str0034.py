...
PATH = 'DOC/SISMSG/STR0034'
PATH_R1 = 'DOC/SISMSG/STR0034R1'
PATH_R2 = 'DOC/SISMSG/STR0034R2'
PATH_E = 'DOC/SISMSG/STR0034'
XML_NAMESPACE = 'http://www.bcb.gov.br/SPB/STR0034.xsd'
XML_NAMESPACE_ERROR = 'http://www.bcb.gov.br/SPB/STR0034E.xsd'


class STR0034(PartyValidations, BaseMessage):
    XML_NAMESPACE: ClassVar[str | None] = XML_NAMESPACE

    document_parties: ClassVar[list[str]] = ['debtor', 'creditor', 'investor']
    ...
    message_code: Annotated[Literal['STR0034'], XmlPath(f'{PATH}/CodMsg/text()')] = 'STR0034'
    ...
    transaction_id: Annotated[TransactionId | None, XmlPath(f'{PATH}/CodCli/text()')] = None
    investor_type: Annotated[PersonType, XmlPath(f'{PATH}/TpPessoaInvest/text()')]
    investor_document: Annotated[Cnpj | Cpf, XmlPath(f'{PATH}/CNPJ_CPFInvest/text()')]
    investor_name: Annotated[Name, XmlPath(f'{PATH}/Nom_RzSocInvest/text()')]
...
class STR0034R1(BaseMessage):
    XML_NAMESPACE: ClassVar[str | None] = XML_NAMESPACE

    message_code: Annotated[Literal['STR0034R1'], XmlPath(f'{PATH_R1}/CodMsg/text()')] = 'STR0034R1'
...
class STR0034R2(PartyValidations, BaseMessage):
    XML_NAMESPACE: ClassVar[str | None] = XML_NAMESPACE
    ...
    message_code: Annotated[Literal['STR0034R2'], XmlPath(f'{PATH_R2}/CodMsg/text()')] = 'STR0034R2'
    ...
    transaction_id: Annotated[TransactionId | None, XmlPath(f'{PATH_R2}/CodCli/text()')] = None
    investor_type: Annotated[PersonType, XmlPath(f'{PATH_R2}/TpPessoaInvest/text()')]
    investor_document: Annotated[Cnpj | Cpf, XmlPath(f'{PATH_R2}/CNPJ_CPFInvest/text()')]
    investor_name: Annotated[Name, XmlPath(f'{PATH_R2}/Nom_RzSocInvest/text()')]
...
class STR0034E(PartyValidations, BaseMessage):
    ...
    message_code: Annotated[Literal['STR0034E'], XmlPath(f'{PATH_E}/CodMsg/text()')] = 'STR0034E'
    ...
    transaction_id: Annotated[TransactionId | None, XmlPath(f'{PATH_E}/CodCli/text()')] = None
    investor_type: Annotated[PersonType | None, XmlPath(f'{PATH_E}/TpPessoaInvest/text()')] = None
    investor_document: Annotated[Cnpj | Cpf | None, XmlPath(f'{PATH_E}/CNPJ_CPFInvest/text()')] = None
    investor_name: Annotated[Name | None, XmlPath(f'{PATH_E}/Nom_RzSocInvest/text()')] = None
    ...
    creditor_document_error_code: Annotated[ErrorCode | None, XmlPath(f'{PATH_E}/CNPJ_CPFCliCredtd/@CodErro')] = None
    ...
    transaction_id_error_code: Annotated[ErrorCode | None, XmlPath(f'{PATH_E}/CodCli/@CodErro')] = None
    investor_type_error_code: Annotated[ErrorCode | None, XmlPath(f'{PATH_E}/TpPessoaInvest/@CodErro')] = None
    investor_document_error_code: Annotated[ErrorCode | None, XmlPath(f'{PATH_E}/CNPJ_CPFInvest/@CodErro')] = None
    investor_name_error_code: Annotated[ErrorCode | None, XmlPath(f'{PATH_E}/Nom_RzSocInvest/@CodErro')] = None
