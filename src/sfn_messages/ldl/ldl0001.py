...
class LDL0001E(BaseMessage):
    ...
    message_code: Annotated[Literal['LDL0001E'], XmlPath(f'{PATH_E}/CodMsg/text()')] = 'LDL0001E'
    ...
    information_type: Annotated[InformationType | None, XmlPath(f'{PATH_E}/TpInf/text()')] = None
